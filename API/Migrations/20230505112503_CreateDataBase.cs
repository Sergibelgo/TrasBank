    ...
    public partial class CreateDataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TranssactionTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkerStatusId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Workers_WorkerStatuses_WorkerStatusId",
                        column: x => x.WorkerStatusId,
                        principalTable: "WorkerStatuses",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customers_Workers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "Workers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customers_WorkingStates_WorkStatusId",
                        column: x => x.WorkStatusId,
                        principalTable: "WorkingStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ammount = table.Column<decimal>(type: "decimal(30,2)", precision: 30, scale: 2, nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Sender_AccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.Sender_AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_TranssactionTypes_TransactionTypeId",
                        column: x => x.TransactionTypeId,
                        principalTable: "TranssactionTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LoanId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FIN = table.Column<decimal>(type: "decimal(30,2)", precision: 30, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_WorkerId",
                table: "Customers",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_WorkStatusId",
                table: "Customers",
                column: "WorkStatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workers_WorkerStatusId",
                table: "Workers",
